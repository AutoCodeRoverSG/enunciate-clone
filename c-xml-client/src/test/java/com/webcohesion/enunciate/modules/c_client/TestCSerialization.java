...
import com.webcohesion.enunciate.examples.c_client.schema.*;
import com.webcohesion.enunciate.rt.QNameEnumUtil;
import junit.framework.TestCase;
import com.webcohesion.enunciate.examples.c_client.schema.animals.Cat;
import com.webcohesion.enunciate.examples.c_client.schema.draw.Canvas;
import com.webcohesion.enunciate.examples.c_client.schema.structures.House;
import com.webcohesion.enunciate.examples.c_client.schema.structures.HouseColor;
import com.webcohesion.enunciate.examples.c_client.schema.structures.HouseStyle;
import com.webcohesion.enunciate.examples.c_client.schema.structures.HouseType;
import com.webcohesion.enunciate.examples.c_client.schema.vehicles.Bus;
import com.webcohesion.enunciate.examples.c_client.schema.vehicles.BusType;
...
public class TestCSerialization extends TestCase {
  ...
  public void testHouse() throws Exception {
    ...
    house.setColor(java.net.URI.create(QNameEnumUtil.toURI(HouseColor.blue)));
...
//    System.out.printf("%s %s %s %s\n", this.exe.getAbsolutePath(), object.getClass().getSimpleName().toLowerCase(), in.getAbsolutePath(), out.getAbsolutePath());
    ...
    assertEquals("Process xml failed.", 0, exitStatus);
