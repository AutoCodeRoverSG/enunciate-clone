 ...
 */
/**
 * @deprecated Use {@link PhpClientClassnameForMethod} instead.
 */
@Deprecated
public class ClientClassnameForMethod extends PhpClientClassnameForMethod {

  public ClientClassnameForMethod(Map<String, String> conversions, EnunciateJaxbContext jaxbContext) {
    super(conversions, jaxbContext);
  }
